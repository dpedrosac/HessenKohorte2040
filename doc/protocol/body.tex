...
\begin{table}[h]
%\caption{Overview on the \ac{MRI}-sequences in use during the \textsc{HessenKohorte}\footnote{protocol is identical to the one used by the \ac{PPMI}-study}}
\small
