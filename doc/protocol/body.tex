...
Our main method for assessing the hypotheses are \acused{ANOVA}\acs{ANOVA}, linear regression and correlation analyses. In particular we will analyse the correlation between the \ac{QoL} of the index patient and of her relatives and caregivers. In order to extend this analysis we will assess different influencing factors as e.g. age, gender and symptom burden (motor and non-motor). Furthermore in an attempt to elucidate the causal form of the interdependence we will analyse how \ac{QoL} of patients/caregivers at earlier timepoints relates to \ac{QoL} of caregivers/patients at a later point in time.
...
% Urs: Kannst Du hier einmal einen kurzen Text interdisziplinären Treffen alle vier Wochen schreiben, bei denen die Patient:innen aus den letzten 30 Tagen besprochen werden und über etwaige Ausschlüsse/Maßnahmen gesprochen wird?
