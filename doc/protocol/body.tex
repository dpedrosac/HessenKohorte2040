...
% TODO: We need a brief description of the CHAPO model. @Marlena
...
\hline
% Translate the items of the internal consistency to english @ David?
...
\hline
% Vincent writes different categories for the internal consistency (fen F., phy F., red. Akt., red Mot., men F., espectively) -> elaborate @David
...
%TODO: What is the SCID abbreviation? Why is there only a confidence interval? @David?
\hline
\end{tabularx}
...
% Don't understand, please double check! @?
\hline
\textbf{Interrater validity/reliability} 				& 												& 												\\
\hline
\end{tabularx}
