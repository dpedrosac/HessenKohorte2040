...
\input{table_inclusion_and_exclusion_criteria_patients.tex}
% Urs: Es fehlt noch das Alter bei den inclusion criteria (habe den Punkt in die Datei; table_inclusion_and_exclusion_criteria_patients.tex eingefügt)
...
\input{table_inclusion_and_exclusion_criteria_relatives.tex}
...
\input{table_data_collection_schedule_patients.tex}
\input{table_data_collection_schedule_relatives.tex}
...
\input{table_psychometrics_moca.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_bdi.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_cbi.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_ciss.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_mfi20.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_pdcb.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_phq.tex} %TODO: The values are missing, as well as the source,@David?
...
\underline{Psychometrics:}
\input{table_psychometrics_pss.tex}
...
\underline{Psychometrics:}
\input{table_psychometrics_whoqol.tex}
