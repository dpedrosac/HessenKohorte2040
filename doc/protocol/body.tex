...
\tabitem{Quality of life of the relatives of the index patient}
\tabitem{Motor symptoms of the index patient}
\tabitem{Non-motor symptoms of the index patient}
\\ \midrule
...
\textbf{Inclusion criteria \ac{PD}-patients} &
\tabitem{Patients with a clinical diagnosis of idiopathic Parkinson's
  syndrome according to the recent clinical diagnostic criteria
  (Quelle Postuma)} \\
& \tabitem{\ac{iPS}-stages of I - IV according to the Hoehn \& Yahr
  scale (without medication, i.e. in the OFF stage) (Quelle Hoehn und
  Yahr 1967).} \\
...
\tabitem{Patients suffering from a clinical diagnosis of atypic
  ...
  excluded.}\\
& \tabitem{\ac{iPS}-stages of V according to the Hoehn \& Yahr scale
